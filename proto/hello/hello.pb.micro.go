...
func (c *helloService) Hi(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *helloHandler) Hi(ctx context.Context, in *Request, out *Response) error {
